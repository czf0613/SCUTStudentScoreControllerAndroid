...
/** 
 * DAO for table "LOCAL_CACHE".
*/
public class LocalCacheDao extends AbstractDao<LocalCache, Long> {

    public static final String TABLENAME = "LOCAL_CACHE";

    /**
     * Properties of entity LocalCache.<br/>
    ...
    public LocalCacheDao(DaoConfig config) {
        super(config);
    }
    
    public LocalCacheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_LOCAL_CACHE_label ON \"LOCAL_CACHE\"" +
                " (\"label\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_CACHE\"";
        db.execSQL(sql);
    }
    ...
    @Override
    protected final Long updateKeyAfterInsert(LocalCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(LocalCache entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
